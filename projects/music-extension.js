...
if (tosCheckbox.checked) {
    ...
    tosLabel.innerHTML = 'I agree to the <a href="/TOS.html" target="_blank">Term of service</a>';
} else {
    downloadButton.setAttribute('disabled', 'disabled');
    tosLabel.innerHTML = 'I <span style="text-decoration: underline;">disagree</span> to the <a href="/TOS.html" target="_blank">Term of service</a>';
}
});
